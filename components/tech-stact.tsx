...
const TechStack = () => {
  return (
    <section className="font-space mt-16 space-y-10">
      ...
      />
      <div className="flex gap-2 flex-wrap max-w-lg mx-auto">
        <Badge className="rounded-md">NextJs</Badge>
        <Badge className="rounded-md">React</Badge>
        <Badge className="rounded-md">Tailwindcss</Badge>
        <Badge className="rounded-md">javascript</Badge>
        <Badge className="rounded-md">typescript</Badge>
        <Badge className="rounded-md">node</Badge>
        <Badge className="rounded-md">mongodb</Badge>
        <Badge className="rounded-md">express</Badge>
        <Badge className="rounded-md">git</Badge>
        <Badge className="rounded-md">github</Badge>
        <Badge className="rounded-md">docker</Badge>
      </div>
    </section>
  );
};
